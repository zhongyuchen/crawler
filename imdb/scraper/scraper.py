"""
This script scrapes IMDB and outputs a CSV file with 50 highest rated movies.
"""
...
def extract_movies(dom):
    ...
    # EXTRACT THE ABOVE INFORMATION ABOUT THE HIGHEST RATED MOVIES
    # NOTE: FOR THIS EXERCISE YOU ARE ALLOWED (BUT NOT REQUIRED) TO IGNORE
    # UNICODE CHARACTERS AND SIMPLY LEAVE THEM OUT OF THE OUTPUT.

    movie_list = dom.find_all("div", class_="lister-item-content")

    # Extract, process and store the data in a dictionary.
    movies = []
    for movie in movie_list:
        ...
        if staff_1st:
            ...
            while actor_p.name == "a":
                ...
                actor_p = actor_p.find_next()
            # Usage of encode() and decode() can ignore unicode characters
